...
class ParticipantInline(admin.TabularInline):
    ...
    fields = ("nickname", "contribution_amount", "joined_at")
...
class ParlayAdmin(admin.ModelAdmin):
    ...
    list_filter = ("status", "sportsbook", "is_public")
    search_fields = ("slug", "creator_nickname", "id")
    ...
    fieldsets = (
        ...
        (
            "Identifiers",
            {"fields": ("id", "slug", "external_link", "notes")},
        ),
